...
const FEATURED_GRID_TOOLS: GridTool[] = [
  ...
  { name: 'Midjourney', query: 'Midjourney', category: 'Image Gen', bgColor: '#1E1B4B', url: 'https://midjourney.com', icon: '🎨' },
  ...
  { name: 'Flux', query: 'Flux', category: 'Image Gen', bgColor: '#0f172a', url: 'https://blackforestlabs.ai', icon: '🖼️' },
  ...
  { name: 'Sora', query: 'Sora', category: 'Video AI', bgColor: '#000000', url: 'https://openai.com/sora', icon: '🎥' },
